#include "product_delete.h"
#include "ui_product_delete.h"
#include "mainwindow.h"
#include <QMessageBox>

product_delete::product_delete(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::product_delete)
{
    ui->setupUi(this);
...
void product_delete::on_delbtn_clicked()
{
    QString sale, code, p_code, product;
    QSqlQuery q;

    sale = ui->life_comboBox->currentText();
...
void product_delete::on_cartagory_comboBox_activated(int index)
{
...
void product_delete::on_product_comboBox_activated(int index)
{
}
